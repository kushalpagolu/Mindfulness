...
struct PlaceOrderButton: View {
    ...
    struct Place: View {
        var body: some View {
            Group { Text("Place").foregroundColor(.black) + Text(" Order").foregroundColor(.clear) }.padding(20)
        }
    }

    struct Order: View {
        var body: some View {
            Group { Text("Place").foregroundColor(.clear) + Text(" Order").foregroundColor(.black) }.padding(20)
        }
    }
